...
Для выделения текста курсивом необходимо поставить звездочки с двух сторон. например *текст*

для выделения полужирным необходимо добавить по две звездочки с двух сторон. Например **текст**

## Списки

Для создания списком добавляем звездочку + пробел
например:
* текст
* текст

список номированные указываем цифру и точку.
например:
1. текст
2. текст
